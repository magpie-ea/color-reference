                ...
                const viewTemplate = `
                        <div class="magpie-view">
                            ...
                            <section class="magpie-text-container">
                                <p id="lobby-text" class="magpie-view-text">${this.text}</p>
                            </section>
                        </div>
                `;
        ...
        const _lobby = {
            ...
            render: function (CT, magpie) {
                ...
                magpie.gameChannel = magpie.socket.channel(
                    `interactive_room:${magpie.deploy.experimentID}:${magpie.chain}:${magpie.variant}:${magpie.generation}`,
                    { participant_id: magpie.participant_id }
                );
                ...
                let setUpOneRound = function (colors) {
                    ...
                    console.log(
                        'Todo: Positions are logged the same for listener and speaker even though they differ'
                    );
                    ...
                    if (magpie.player == 2) {
                        ...
                        for (let div of color_divs) {
                            div.onclick = (e) => {
                                ...
                                console.log(
                                    `trial_counter is ${magpie.trial_counter}, num_game_trials is ${magpie.num_game_trials}`
                                );
                                if (
                ...
                magpie.gameChannel.on('new_msg', (payload) => {
                    ...
                    magpie.listener_timestamps.push(
                        payload.listener_timestamps
                    );
                });
    ...
    game: function (config) {
        const _game = {
            ...
            render: function (CT, magpie) {
                const viewTemplate = `
                    <div class='magpie-view'>
                        <h1 id="title" class='magpie-view-title'>${this.title}</h1>
                        <section class="magpie-text-container">
                ...
                if (
                    ...
                    $('#main').html(
                        `<div class='magpie-view magpie-thanks-view'>
                            ...
                            <h1 id='thanks-message' class='magpie-thanks magpie-nodisplay'>${this.title}</h1>
                        </div>`
                    );
                    ...
                    $('#main').html(
                        `<div class='magpie-view magpie-thanks-view'>
                            ...
                            <p id='extra-message' class='magpie-view-text magpie-nodisplay'>
                                ...
                                <a href="${magpie.deploy.prolificURL}" class="magpie-view-button prolific-url">Confirm</a>
                            </p>
                        </div>`
                    );
